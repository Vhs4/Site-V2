...
const AboutSection = () => {
    return (
        <section className="flex flex-col items-center justify-between w-full max-w-full mt-[150px] mb-[92px]">
            <div className="z-10 w-full max-md:max-w-full px-12 flex items-center md:justify-start md:items-start justify-center md:px-[100px] lg:px-[300px] mb-[114px]">
                <div className="w-full flex justify-center flex-col lg:flex-row lg:justify-between items-center flex-wrap gap-5">
